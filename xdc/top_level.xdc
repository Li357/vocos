...
set_property -dict {PACKAGE_PIN F14 IOSTANDARD LVCMOS33}  [ get_ports "pmoda_lout_mclk" ]
set_property -dict {PACKAGE_PIN F15 IOSTANDARD LVCMOS33}  [ get_ports "pmoda_lout_lrck" ]
set_property -dict {PACKAGE_PIN H13 IOSTANDARD LVCMOS33}  [ get_ports "pmoda_lout_sclk" ]
set_property -dict {PACKAGE_PIN H14 IOSTANDARD LVCMOS33}  [ get_ports "pmoda_lout_sdin" ]
set_property -dict {PACKAGE_PIN J13 IOSTANDARD LVCMOS33}  [ get_ports "pmoda_lin_mclk" ]
set_property -dict {PACKAGE_PIN J14 IOSTANDARD LVCMOS33}  [ get_ports "pmoda_lin_lrck" ]
set_property -dict {PACKAGE_PIN E14 IOSTANDARD LVCMOS33}  [ get_ports "pmoda_lin_sclk" ]
set_property -dict {PACKAGE_PIN E15 IOSTANDARD LVCMOS33}  [ get_ports "pmoda_lin_sdout" ]
#fixed K14 and J15 which were a copy-paste and wrong.
set_property -dict {PACKAGE_PIN H18 IOSTANDARD LVCMOS33}  [ get_ports {pmodb_sel} ]
set_property -dict {PACKAGE_PIN G18 IOSTANDARD LVCMOS33}  [ get_ports {pmodb_ws} ]
set_property -dict {PACKAGE_PIN K14 IOSTANDARD LVCMOS33}  [ get_ports {pmodb_dout} ]
set_property -dict {PACKAGE_PIN J15 IOSTANDARD LVCMOS33}  [ get_ports {pmodb_bclk} ]
...
# USB_SPI_MOSI
set_property -dict { PACKAGE_PIN V15   IOSTANDARD LVCMOS33 } [get_ports { usb_mosi }]; #IO_L20N_T3_A07_D23_14        Sch=jd1/ck_io[33]
# USB_SPI_CCLK
set_property -dict { PACKAGE_PIN V14   IOSTANDARD LVCMOS33 } [get_ports { usb_clk }]; #IO_L20P_T3_A08_D24_14        Sch=jc10/ck_io[34]
